<template>
    ...
    <div style="display:none;">
        <img v-for="alertTemplate in alertTemplates" 
            :id="alertTemplate.imageId" 
            :src="'/src/media/' + alertTemplate.imageFile" 
            :width="alertTemplate.imageWidth" 
            :height="alertTemplate.imageHeight"
        />
        <audio v-for="alertTemplate in alertTemplates" 
            :id="alertTemplate.audioId" 
            :src="'/src/media/' + alertTemplate.audioFile" 
